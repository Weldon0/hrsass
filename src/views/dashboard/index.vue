  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img v-imgerror="defaultImg" :src="userInfo.staffPhoto" alt="">
          </div>
    ...
    <el-dialog :visible="showDialog" title="离职申请" @close="btnCancel">
      ...
      <el-row slot="footer" type="flex" justify="center">
        <el-col :span="6">
          <el-button size="small" type="primary" @click="btnOK">{{ $t('table.confirm') }}</el-button>
...
export default {
  ...
  data: function() {
    return {
      ...
      rules: {
        exceptTime: [
          getRequiredRules('离职时间')
        ],
        reason: [
          getRequiredRules('离职原因')
        ]
      },
      showDialog: false,
      ruleForm: {
